...
╚════════════════════════════════════╝
  ...
  Save to Database → Add to Queue
        ↓
  Notify Users / Volunteers
        ↓
  Task Assigned → Mark Complete → +Karma

╔════════════════════════════════════╗
║   2. Volunteer for Help            ║
╚════════════════════════════════════╝
        ↓
  Join Request Queue (FIFO)
        ↓
  Assigned by Order
        ↓
  Task Marked Complete → +Karma

╔════════════════════════════════════╗
║   3. Comment on Request            ║
╚════════════════════════════════════╝
        ↓
  Save Edit to Stack
        ↓
...
╚════════════════════════════════════╝
  ...
  Create Graph Edges
        ↓
  Suggest Friends → DFS/BFS Traversal

╔════════════════════════════════════╗
║   5. Create Task Flows             ║
╚════════════════════════════════════╝
        ↓
  Define Dependencies (Graph)
        ↓
  Cannot Complete Child Task Until Parent is Done

╔════════════════════════════════════╗
║   6. Group Collaboration           ║
╚════════════════════════════════════╝
        ↓
  Group Boards → Tasks/Discussions
        ↓
  Admin Moderation Tools
